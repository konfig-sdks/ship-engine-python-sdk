...
from ship_engine_python_sdk.model.purchase_label_without_shipment import PurchaseLabelWithoutShipment as PurchaseLabelWithoutShipmentSchema
...
from ship_engine_python_sdk.type.purchase_label_without_shipment import PurchaseLabelWithoutShipment
...
from ship_engine_python_sdk.pydantic.purchase_label_without_shipment import PurchaseLabelWithoutShipment as PurchaseLabelWithoutShipmentPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'rate_id': typing.Union[SeIdSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = PurchaseLabelWithoutShipmentSchema


request_body_purchase_label_without_shipment = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purchase_label_with_rate_id_mapped_args(
        self,
        rate_id: SeId,
    ...
    async def _apurchase_label_with_rate_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/labels/rates/{rate_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_purchase_label_without_shipment.serialize(body, content_type)
    ...
    def _purchase_label_with_rate_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PurchaseLabelWithRateIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurchase_label_with_rate_id(
        self,
        rate_id: SeId,
        validate_address: typing.Optional[ValidateAddress] = None,
        label_layout: typing.Optional[LabelLayout] = None,
        ...
        **kwargs,
        ...
        args = self._purchase_label_with_rate_id_mapped_args(
            rate_id=rate_id,
        ...
        return await self._apurchase_label_with_rate_id_oapg(
            body=args.body,
    ...
    def purchase_label_with_rate_id(
        ...
        return self._purchase_label_with_rate_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class PurchaseLabelWithRateId(BaseApi):
    ...
    async def apurchase_label_with_rate_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurchase_label_with_rate_id(
            rate_id=rate_id,
            validate_address=validate_address,
            label_layout=label_layout,
            label_format=label_format,
    ...
    def purchase_label_with_rate_id(
        ...
        raw_response = self.raw.purchase_label_with_rate_id(
            rate_id=rate_id,
            validate_address=validate_address,
            label_layout=label_layout,
            label_format=label_format,
