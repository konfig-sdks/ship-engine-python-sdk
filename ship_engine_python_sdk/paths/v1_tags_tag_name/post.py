...
SchemaFor200ResponseBodyApplicationJson = TagSchema
    ...
    async def _atag_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tags/{tag_name}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class TagRaw(BaseApi):
    ...
    async def atag(
        ...
        **kwargs,
        ...
        args = self._tag_mapped_args(
            tag_name=tag_name,
        )
        return await self._atag_oapg(
...
class Tag(BaseApi):
    ...
    async def atag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atag(
            tag_name=tag_name,
            **kwargs,
        )
        if validate:
            return TagPydantic(**raw_response.body)
        return api_client.construct_model_instance(TagPydantic, raw_response.body)
