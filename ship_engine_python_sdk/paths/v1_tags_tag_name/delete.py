...
class Tag0Raw(BaseApi):
    ...
    async def atag_0(
        ...
        **kwargs,
        ...
        args = self._tag_0_mapped_args(
            tag_name=tag_name,
        )
        return await self._atag_0_oapg(
...
class Tag0(BaseApi):
    ...
    async def atag_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atag_0(
            tag_name=tag_name,
            **kwargs,
        )
        if validate:
