...
from ship_engine_python_sdk.model.list_batch_errors_response_body import ListBatchErrorsResponseBody as ListBatchErrorsResponseBodySchema
...
from ship_engine_python_sdk.type.list_batch_errors_response_body import ListBatchErrorsResponseBody
...
from ship_engine_python_sdk.pydantic.list_batch_errors_response_body import ListBatchErrorsResponseBody as ListBatchErrorsResponseBodyPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'batch_id': typing.Union[SeIdSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = ListBatchErrorsResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListBatchErrorsResponseBody
    ...
    async def _aget_errors_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/{batch_id}/errors',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetErrorsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_errors(
        self,
        batch_id: SeId,
        page: typing.Optional[int] = None,
        pagesize: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_errors_mapped_args(
            batch_id=batch_id,
            page=page,
            pagesize=pagesize,
        )
        return await self._aget_errors_oapg(
    ...
    def get_errors(
        ...
        return self._get_errors_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetErrors(BaseApi):
    ...
    async def aget_errors(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListBatchErrorsResponseBodyPydantic:
        raw_response = await self.raw.aget_errors(
            batch_id=batch_id,
            page=page,
            pagesize=pagesize,
            **kwargs,
        ...
        if validate:
            return ListBatchErrorsResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListBatchErrorsResponseBodyPydantic, raw_response.body)
    ...
    def get_errors(
        ...
        raw_response = self.raw.get_errors(
            batch_id=batch_id,
            page=page,
            pagesize=pagesize,
        )
