...
from ship_engine_python_sdk.model.modify_batch import ModifyBatch as ModifyBatchSchema
...
from ship_engine_python_sdk.type.modify_batch import ModifyBatch
...
from ship_engine_python_sdk.pydantic.modify_batch import ModifyBatch as ModifyBatchPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ModifyBatchSchema


request_body_modify_batch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_from_batch_mapped_args(
        self,
        batch_id: SeId,
    ...
    async def _aremove_from_batch_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/{batch_id}/remove',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_modify_batch.serialize(body, content_type)
...
class RemoveFromBatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_batch(
        self,
        batch_id: SeId,
        shipment_ids: typing.Optional[typing.List[SeId]] = None,
        rate_ids: typing.Optional[typing.List[SeId]] = None,
        **kwargs,
        ...
        args = self._remove_from_batch_mapped_args(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
        )
        return await self._aremove_from_batch_oapg(
            body=args.body,
    ...
    def remove_from_batch(
        ...
        return self._remove_from_batch_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveFromBatch(BaseApi):
    ...
    async def aremove_from_batch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_batch(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
            **kwargs,
    ...
    def remove_from_batch(
        ...
        raw_response = self.raw.remove_from_batch(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
        )
