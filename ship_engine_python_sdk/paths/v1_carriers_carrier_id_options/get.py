...
from ship_engine_python_sdk.model.get_carrier_options_response_body import GetCarrierOptionsResponseBody as GetCarrierOptionsResponseBodySchema

from ship_engine_python_sdk.type.get_carrier_options_response_body import GetCarrierOptionsResponseBody
...
from ship_engine_python_sdk.pydantic.get_carrier_options_response_body import GetCarrierOptionsResponseBody as GetCarrierOptionsResponseBodyPydantic
...
SchemaFor200ResponseBodyApplicationJson = GetCarrierOptionsResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetCarrierOptionsResponseBody
    ...
    async def _aget_options_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/carriers/{carrier_id}/options',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetOptions(BaseApi):
    ...
    async def aget_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetCarrierOptionsResponseBodyPydantic:
        raw_response = await self.raw.aget_options(
            carrier_id=carrier_id,
            **kwargs,
        )
        if validate:
            return GetCarrierOptionsResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(GetCarrierOptionsResponseBodyPydantic, raw_response.body)
