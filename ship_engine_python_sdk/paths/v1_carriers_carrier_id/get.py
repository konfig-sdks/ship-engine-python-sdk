...
from ship_engine_python_sdk.model.carrier import Carrier as CarrierSchema
...
from ship_engine_python_sdk.type.carrier import Carrier
...
from ship_engine_python_sdk.pydantic.carrier import Carrier as CarrierPydantic
...
SchemaFor200ResponseBodyApplicationJson = CarrierSchema
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return CarrierPydantic(**raw_response.body)
        return api_client.construct_model_instance(CarrierPydantic, raw_response.body)
