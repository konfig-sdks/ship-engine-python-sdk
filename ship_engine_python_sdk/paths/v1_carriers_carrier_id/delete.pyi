...
class BaseApi(api_client.Api):
    ...
    def _disconnect_by_id_mapped_args(
        self,
        carrier_id: SeId,
    ...
    async def _adisconnect_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/carriers/{carrier_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DisconnectByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisconnect_by_id(
        self,
        carrier_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._disconnect_by_id_mapped_args(
            carrier_id=carrier_id,
        )
        return await self._adisconnect_by_id_oapg(
    ...
    def disconnect_by_id(
        ...
        return self._disconnect_by_id_oapg(
            path_params=args.path,
        )

class DisconnectById(BaseApi):
    ...
    async def adisconnect_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adisconnect_by_id(
            carrier_id=carrier_id,
            **kwargs,
        )
        if validate:
    ...
    def disconnect_by_id(
        ...
        raw_response = self.raw.disconnect_by_id(
            carrier_id=carrier_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
