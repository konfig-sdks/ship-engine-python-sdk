...
from ship_engine_python_sdk.model.get_service_point_by_id_response_body import GetServicePointByIdResponseBody as GetServicePointByIdResponseBodySchema
from ship_engine_python_sdk.model.error_response_body import ErrorResponseBody as ErrorResponseBodySchema

from ship_engine_python_sdk.type.get_service_point_by_id_response_body import GetServicePointByIdResponseBody
from ship_engine_python_sdk.type.error_response_body import ErrorResponseBody

from ...api_client import Dictionary
from ship_engine_python_sdk.pydantic.get_service_point_by_id_response_body import GetServicePointByIdResponseBody as GetServicePointByIdResponseBodyPydantic
...
class CountryCodeSchema(
    ...
    class MetaOapg:
        max_length = 2
        min_length = 2
ServicePointIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'carrier_code': typing.Union[CarrierCodeSchema, str, ],
        'country_code': typing.Union[CountryCodeSchema, str, ],
        'service_point_id': typing.Union[ServicePointIdSchema, str, ],
    }
)
...
request_path_carrier_code = api_client.PathParameter(
    name="carrier_code",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CarrierCodeSchema,
    required=True,
)
...
request_path_service_point_id = api_client.PathParameter(
    name="service_point_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ServicePointIdSchema,
    required=True,
)
_auth = [
    'api_key',
]
SchemaFor200ResponseBodyApplicationJson = GetServicePointByIdResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetServicePointByIdResponseBody
...
class BaseApi(api_client.Api):
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_carrier_code,
            request_path_country_code,
            request_path_service_point_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/service_points/{carrier_code}/{country_code}/{service_point_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetServicePointByIdResponseBodyPydantic:
        ...
        if validate:
            return GetServicePointByIdResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(GetServicePointByIdResponseBodyPydantic, raw_response.body)
