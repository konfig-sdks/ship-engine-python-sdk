...
from ship_engine_python_sdk.model.create_label_from_shipment_request_body import CreateLabelFromShipmentRequestBody as CreateLabelFromShipmentRequestBodySchema
...
from ship_engine_python_sdk.type.create_label_from_shipment_request_body import CreateLabelFromShipmentRequestBody
...
from ship_engine_python_sdk.pydantic.create_label_from_shipment_request_body import CreateLabelFromShipmentRequestBody as CreateLabelFromShipmentRequestBodyPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateLabelFromShipmentRequestBodySchema


request_body_create_label_from_shipment_request_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purchase_label_with_shipment_id_mapped_args(
        self,
        shipment_id: SeId,
    ...
    async def _apurchase_label_with_shipment_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/labels/shipment/{shipment_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_label_from_shipment_request_body.serialize(body, content_type)
    ...
    def _purchase_label_with_shipment_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class PurchaseLabelWithShipmentIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurchase_label_with_shipment_id(
        self,
        shipment_id: SeId,
        validate_address: typing.Optional[ValidateAddress] = None,
        label_layout: typing.Optional[LabelLayout] = None,
        ...
        **kwargs,
        ...
        args = self._purchase_label_with_shipment_id_mapped_args(
        ...
        return await self._apurchase_label_with_shipment_id_oapg(
            body=args.body,
    ...
    def purchase_label_with_shipment_id(
        ...
        return self._purchase_label_with_shipment_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class PurchaseLabelWithShipmentId(BaseApi):
    ...
    async def apurchase_label_with_shipment_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurchase_label_with_shipment_id(
            shipment_id=shipment_id,
            validate_address=validate_address,
            label_layout=label_layout,
            label_format=label_format,
    ...
    def purchase_label_with_shipment_id(
        ...
        raw_response = self.raw.purchase_label_with_shipment_id(
            shipment_id=shipment_id,
            validate_address=validate_address,
            label_layout=label_layout,
            label_format=label_format,
