...
class Webhook1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awebhook_1(
        self,
        webhook_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._webhook_1_mapped_args(
            webhook_id=webhook_id,
        )
        return await self._awebhook_1_oapg(
    ...
    def webhook_1(
        ...
        return self._webhook_1_oapg(
            path_params=args.path,
        )

class Webhook1(BaseApi):
    ...
    async def awebhook_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awebhook_1(
            webhook_id=webhook_id,
            **kwargs,
        )
        if validate:
    ...
    def webhook_1(
        ...
        raw_response = self.raw.webhook_1(
            webhook_id=webhook_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
