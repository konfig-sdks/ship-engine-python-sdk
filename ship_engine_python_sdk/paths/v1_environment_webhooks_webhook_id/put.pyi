...
from ship_engine_python_sdk.model.update_webhook_request_body import UpdateWebhookRequestBody as UpdateWebhookRequestBodySchema
...
from ship_engine_python_sdk.type.update_webhook_request_body import UpdateWebhookRequestBody
...
from ship_engine_python_sdk.pydantic.update_webhook_request_body import UpdateWebhookRequestBody as UpdateWebhookRequestBodyPydantic
from ship_engine_python_sdk.pydantic.url import Url as UrlPydantic

# Path params
WebhookIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'webhook_id': typing.Union[SeIdSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = UpdateWebhookRequestBodySchema


request_body_update_webhook_request_body = api_client.RequestBody(
    content={
    ...
    async def _awebhook_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/environment/webhooks/{webhook_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_webhook_request_body.serialize(body, content_type)
...
class Webhook0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awebhook_0(
        self,
        webhook_id: SeId,
        url: typing.Optional[Url] = None,
        headers: typing.Optional[typing.List[WebhookHeader]] = None,
        **kwargs,
        ...
        args = self._webhook_0_mapped_args(
            webhook_id=webhook_id,
            url=url,
            headers=headers,
        )
        return await self._awebhook_0_oapg(
            body=args.body,
    ...
    def webhook_0(
        ...
        return self._webhook_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class Webhook0(BaseApi):
    ...
    async def awebhook_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awebhook_0(
            webhook_id=webhook_id,
            url=url,
            headers=headers,
            **kwargs,
    ...
    def webhook_0(
        ...
        raw_response = self.raw.webhook_0(
            webhook_id=webhook_id,
            url=url,
            headers=headers,
        )
