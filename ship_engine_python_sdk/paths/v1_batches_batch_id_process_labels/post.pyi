...
from ship_engine_python_sdk.model.process_batch_request_body import ProcessBatchRequestBody as ProcessBatchRequestBodySchema
...
from ship_engine_python_sdk.type.process_batch_request_body import ProcessBatchRequestBody
...
from ship_engine_python_sdk.pydantic.process_batch_request_body import ProcessBatchRequestBody as ProcessBatchRequestBodyPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProcessBatchRequestBodySchema


request_body_process_batch_request_body = api_client.RequestBody(
    content={
    ...
    async def _abatch_2_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/{batch_id}/process/labels',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_process_batch_request_body.serialize(body, content_type)
...
class Batch2Raw(BaseApi):
    ...
    async def abatch_2(
        ...
        **kwargs,
        ...
        args = self._batch_2_mapped_args(
            batch_id=batch_id,
            ship_date=ship_date,
        ...
        return await self._abatch_2_oapg(
            body=args.body,
    ...
    def batch_2(
        ...
        return self._batch_2_oapg(
            body=args.body,
            path_params=args.path,
        )

class Batch2(BaseApi):
    ...
    async def abatch_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abatch_2(
            batch_id=batch_id,
            ship_date=ship_date,
            label_layout=label_layout,
            label_format=label_format,
