...
from ship_engine_python_sdk.model.rates_information import RatesInformation as RatesInformationSchema
from ship_engine_python_sdk.model.error_response_body import ErrorResponseBody as ErrorResponseBodySchema

from ship_engine_python_sdk.type.rates_information import RatesInformation
...
from ship_engine_python_sdk.pydantic.rates_information import RatesInformation as RatesInformationPydantic
...
SchemaFor200ResponseBodyApplicationJson = RatesInformationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RatesInformation
...
class BaseApi(api_client.Api):
    ...
    def _get_rates_for_shipment_mapped_args(
        self,
        shipment_id: SeId,
    ...
    async def _aget_rates_for_shipment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/shipments/{shipment_id}/rates',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_rates_for_shipment_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetRatesForShipmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rates_for_shipment(
        self,
        shipment_id: SeId,
        created_at_start: typing.Optional[datetime] = None,
        **kwargs,
        ...
        args = self._get_rates_for_shipment_mapped_args(
            shipment_id=shipment_id,
            created_at_start=created_at_start,
        )
        return await self._aget_rates_for_shipment_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_rates_for_shipment(
        self,
        shipment_id: SeId,
        created_at_start: typing.Optional[datetime] = None,
    ) -> typing.Union[
        ...
        return self._get_rates_for_shipment_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRatesForShipment(BaseApi):
    ...
    async def aget_rates_for_shipment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RatesInformationPydantic:
        raw_response = await self.raw.aget_rates_for_shipment(
            shipment_id=shipment_id,
            created_at_start=created_at_start,
            **kwargs,
        )
        if validate:
            return RatesInformationPydantic(**raw_response.body)
        return api_client.construct_model_instance(RatesInformationPydantic, raw_response.body)
    ...
    def get_rates_for_shipment(
        ...
        raw_response = self.raw.get_rates_for_shipment(
            shipment_id=shipment_id,
            created_at_start=created_at_start,
        )
        if validate:
