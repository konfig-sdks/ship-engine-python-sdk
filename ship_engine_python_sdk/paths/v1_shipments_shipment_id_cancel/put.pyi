    ...
    async def _ashipments_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/shipments/{shipment_id}/cancel',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Shipments1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashipments_1(
        self,
        shipment_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._shipments_1_mapped_args(
            shipment_id=shipment_id,
        )
        return await self._ashipments_1_oapg(
    ...
    def shipments_1(
        ...
        return self._shipments_1_oapg(
            path_params=args.path,
        )

class Shipments1(BaseApi):
    ...
    async def ashipments_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashipments_1(
            shipment_id=shipment_id,
            **kwargs,
        )
        if validate:
    ...
    def shipments_1(
        ...
        raw_response = self.raw.shipments_1(
            shipment_id=shipment_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
