...
from ship_engine_python_sdk.model.list_carrier_services_response_body import ListCarrierServicesResponseBody as ListCarrierServicesResponseBodySchema
...
from ship_engine_python_sdk.type.list_carrier_services_response_body import ListCarrierServicesResponseBody
...
from ship_engine_python_sdk.pydantic.list_carrier_services_response_body import ListCarrierServicesResponseBody as ListCarrierServicesResponseBodyPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListCarrierServicesResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListCarrierServicesResponseBody
    ...
    async def _alist_services_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/carriers/{carrier_id}/services',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListServices(BaseApi):
    ...
    async def alist_services(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListCarrierServicesResponseBodyPydantic:
        raw_response = await self.raw.alist_services(
            carrier_id=carrier_id,
            **kwargs,
        )
        if validate:
            return ListCarrierServicesResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListCarrierServicesResponseBodyPydantic, raw_response.body)
