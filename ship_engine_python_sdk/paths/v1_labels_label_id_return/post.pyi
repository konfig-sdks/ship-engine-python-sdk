...
from ship_engine_python_sdk.model.create_return_label_request_body import CreateReturnLabelRequestBody as CreateReturnLabelRequestBodySchema
...
from ship_engine_python_sdk.type.create_return_label_request_body import CreateReturnLabelRequestBody
...
from ship_engine_python_sdk.pydantic.create_return_label_request_body import CreateReturnLabelRequestBody as CreateReturnLabelRequestBodyPydantic
...
# Path params
LabelIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'label_id': typing.Union[SeIdSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = CreateReturnLabelRequestBodySchema


request_body_create_return_label_request_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_return_label_mapped_args(
        self,
        label_id: SeId,
    ...
    async def _acreate_return_label_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/labels/{label_id}/return',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_create_return_label_request_body.serialize(body, content_type)
...
class CreateReturnLabelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_return_label(
        self,
        label_id: SeId,
        charge_event: typing.Optional[LabelChargeEvent] = None,
        label_layout: typing.Optional[LabelLayout] = None,
        ...
        **kwargs,
        ...
        args = self._create_return_label_mapped_args(
            label_id=label_id,
        ...
        return await self._acreate_return_label_oapg(
            body=args.body,
    ...
    def create_return_label(
        ...
        return self._create_return_label_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateReturnLabel(BaseApi):
    ...
    async def acreate_return_label(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_return_label(
            label_id=label_id,
            charge_event=charge_event,
            label_layout=label_layout,
            label_format=label_format,
    ...
    def create_return_label(
        ...
        raw_response = self.raw.create_return_label(
            label_id=label_id,
            charge_event=charge_event,
            label_layout=label_layout,
            label_format=label_format,
