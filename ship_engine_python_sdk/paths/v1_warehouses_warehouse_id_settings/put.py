...
from ship_engine_python_sdk.model.update_warehouse_settings_request_body import UpdateWarehouseSettingsRequestBody as UpdateWarehouseSettingsRequestBodySchema
...
from ship_engine_python_sdk.type.update_warehouse_settings_request_body import UpdateWarehouseSettingsRequestBody
...
from ship_engine_python_sdk.pydantic.update_warehouse_settings_request_body import UpdateWarehouseSettingsRequestBody as UpdateWarehouseSettingsRequestBodyPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'warehouse_id': typing.Union[SeIdSchema, ],
    }
)
...
request_path_warehouse_id = api_client.PathParameter(
    name="warehouse_id",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateWarehouseSettingsRequestBodySchema


request_body_update_warehouse_settings_request_body = api_client.RequestBody(
    content={
    ...
    async def _aupdate_settings_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/warehouses/{warehouse_id}/settings',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_warehouse_settings_request_body.serialize(body, content_type)
