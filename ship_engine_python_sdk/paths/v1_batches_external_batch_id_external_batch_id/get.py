...
# Path params
ExternalBatchIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'external_batch_id': typing.Union[ExternalBatchIdSchema, str, ],
    }
)
...
request_path_external_batch_id = api_client.PathParameter(
    name="external_batch_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ExternalBatchIdSchema,
    required=True,
)
_auth = [
    'api_key',
...
class BaseApi(api_client.Api):
    ...
    async def _aget_by_external_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_external_batch_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/external_batch_id/{external_batch_id}',
            auth_settings=_auth,
            headers=_headers,
        )
