    ...
    async def _aadd_to_batch_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/{batch_id}/add',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AddToBatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_batch(
        self,
        batch_id: SeId,
        shipment_ids: typing.Optional[typing.List[SeId]] = None,
        rate_ids: typing.Optional[typing.List[SeId]] = None,
        **kwargs,
        ...
        args = self._add_to_batch_mapped_args(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
        )
        return await self._aadd_to_batch_oapg(
            body=args.body,
    ...
    def add_to_batch(
        ...
        return self._add_to_batch_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddToBatch(BaseApi):
    ...
    async def aadd_to_batch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_batch(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
            **kwargs,
    ...
    def add_to_batch(
        ...
        raw_response = self.raw.add_to_batch(
            batch_id=batch_id,
            shipment_ids=shipment_ids,
            rate_ids=rate_ids,
        )
