...
SchemaFor200ResponseBodyApplicationJson = MonetaryValueSchema
...
class BaseApi(api_client.Api):
    ...
    def _auto_fund_account_mapped_args(
        self,
        currency: str,
    ...
    async def _aauto_fund_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/insurance/shipsurance/add_funds',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AutoFundAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aauto_fund_account(
        self,
        currency: str,
        amount: typing.Union[int, float],
        **kwargs,
        ...
        args = self._auto_fund_account_mapped_args(
            currency=currency,
            amount=amount,
        )
        return await self._aauto_fund_account_oapg(
            body=args.body,
            **kwargs,
        )
    
    def auto_fund_account(
        self,
        currency: str,
        amount: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._auto_fund_account_oapg(
            body=args.body,
        )

class AutoFundAccount(BaseApi):
    ...
    async def aauto_fund_account(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MonetaryValuePydantic:
        raw_response = await self.raw.aauto_fund_account(
            currency=currency,
            amount=amount,
            **kwargs,
        )
        if validate:
            return MonetaryValuePydantic(**raw_response.body)
        return api_client.construct_model_instance(MonetaryValuePydantic, raw_response.body)
    ...
    def auto_fund_account(
        ...
        raw_response = self.raw.auto_fund_account(
            currency=currency,
            amount=amount,
        )
        if validate:
