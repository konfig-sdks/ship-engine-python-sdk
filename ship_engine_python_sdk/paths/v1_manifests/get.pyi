...
from ship_engine_python_sdk.model.list_manifests_response_body import ListManifestsResponseBody as ListManifestsResponseBodySchema
...
from ship_engine_python_sdk.type.list_manifests_response_body import ListManifestsResponseBody
...
from ship_engine_python_sdk.pydantic.list_manifests_response_body import ListManifestsResponseBody as ListManifestsResponseBodyPydantic
...
ShipDateStartSchema = schemas.DateTimeSchema
ShipDateEndSchema = schemas.DateTimeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ship_date_start': typing.Union[ShipDateStartSchema, str, datetime, ],
        'ship_date_end': typing.Union[ShipDateEndSchema, str, datetime, ],
        ...
        'label_ids': typing.Union[LabelIdsSchema, list, tuple, ],
    },
    total=False
)
...
request_query_ship_date_start = api_client.QueryParameter(
    name="ship_date_start",
    style=api_client.ParameterStyle.FORM,
    schema=ShipDateStartSchema,
    explode=True,
)
request_query_ship_date_end = api_client.QueryParameter(
    name="ship_date_end",
    style=api_client.ParameterStyle.FORM,
    schema=ShipDateEndSchema,
    explode=True,
)
...
request_query_label_ids = api_client.QueryParameter(
    name="label_ids",
    style=api_client.ParameterStyle.FORM,
    schema=LabelIdsSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = ListManifestsResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListManifestsResponseBody
...
class BaseApi(api_client.Api):
    ...
    def _manifests_mapped_args(
        self,
        warehouse_id: typing.Optional[SeId] = None,
        ship_date_start: typing.Optional[datetime] = None,
        ship_date_end: typing.Optional[datetime] = None,
        ...
        label_ids: typing.Optional[typing.List[str]] = None,
        ...
        if ship_date_start is not None:
            _query_params["ship_date_start"] = ship_date_start
        if ship_date_end is not None:
            _query_params["ship_date_end"] = ship_date_end
        ...
        if label_ids is not None:
            _query_params["label_ids"] = label_ids
        args.query = _query_params
        return args

    async def _amanifests_oapg(
        self,
...
class ManifestsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amanifests(
        self,
        warehouse_id: typing.Optional[SeId] = None,
        ship_date_start: typing.Optional[datetime] = None,
        ship_date_end: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._manifests_mapped_args(
        ...
        return await self._amanifests_oapg(
    ...
    def manifests(
        ...
        return self._manifests_oapg(
            query_params=args.query,
        )

class Manifests(BaseApi):
    ...
    async def amanifests(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListManifestsResponseBodyPydantic:
        raw_response = await self.raw.amanifests(
            warehouse_id=warehouse_id,
            ship_date_start=ship_date_start,
            ship_date_end=ship_date_end,
            created_at_start=created_at_start,
        ...
        if validate:
            return ListManifestsResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListManifestsResponseBodyPydantic, raw_response.body)
    ...
    def manifests(
        ...
        raw_response = self.raw.manifests(
            warehouse_id=warehouse_id,
            ship_date_start=ship_date_start,
            ship_date_end=ship_date_end,
            created_at_start=created_at_start,
