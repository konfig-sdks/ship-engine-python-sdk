    ...
    async def _abatch_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/batches/{batch_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Batch1Raw(BaseApi):
    ...
    async def abatch_1(
        ...
        **kwargs,
        ...
        args = self._batch_1_mapped_args(
            batch_id=batch_id,
        )
        return await self._abatch_1_oapg(
    ...
    def batch_1(
        ...
        return self._batch_1_oapg(
            path_params=args.path,
        )

class Batch1(BaseApi):
    ...
    async def abatch_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abatch_1(
            batch_id=batch_id,
            **kwargs,
        )
        if validate:
