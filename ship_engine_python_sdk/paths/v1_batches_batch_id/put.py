...
class Batch0Raw(BaseApi):
    ...
    async def abatch_0(
        ...
        **kwargs,
        ...
        args = self._batch_0_mapped_args(
            batch_id=batch_id,
        )
        return await self._abatch_0_oapg(
    ...
    def batch_0(
        ...
        return self._batch_0_oapg(
            path_params=args.path,
        )

class Batch0(BaseApi):
    ...
    async def abatch_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abatch_0(
            batch_id=batch_id,
            **kwargs,
        )
        if validate:
