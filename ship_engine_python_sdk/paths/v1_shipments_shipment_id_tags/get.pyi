...
class BaseApi(api_client.Api):
    ...
    def _get_tags_by_id_mapped_args(
        self,
        shipment_id: SeId,
    ...
    async def _aget_tags_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/shipments/{shipment_id}/tags',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetTagsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tags_by_id(
        self,
        shipment_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_tags_by_id_mapped_args(
            shipment_id=shipment_id,
        )
        return await self._aget_tags_by_id_oapg(
    ...
    def get_tags_by_id(
        ...
        return self._get_tags_by_id_oapg(
            path_params=args.path,
        )

class GetTagsById(BaseApi):
    ...
    async def aget_tags_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tags_by_id(
            shipment_id=shipment_id,
            **kwargs,
        )
        if validate:
    ...
    def get_tags_by_id(
        ...
        raw_response = self.raw.get_tags_by_id(
            shipment_id=shipment_id,
        )
        if validate:
            return TagShipmentResponseBodyPydantic(**raw_response.body)
