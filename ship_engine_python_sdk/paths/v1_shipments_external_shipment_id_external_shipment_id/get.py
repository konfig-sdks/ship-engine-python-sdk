...
SchemaFor200ResponseBodyApplicationJson = PartialShipmentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PartialShipment
    ...
    async def _aget_by_external_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/shipments/external_shipment_id/{external_shipment_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByExternalId(BaseApi):
    ...
    async def aget_by_external_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PartialShipmentPydantic:
        raw_response = await self.raw.aget_by_external_id(
            external_shipment_id=external_shipment_id,
            **kwargs,
        )
        if validate:
            return PartialShipmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(PartialShipmentPydantic, raw_response.body)
