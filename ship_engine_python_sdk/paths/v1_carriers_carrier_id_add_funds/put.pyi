...
from ship_engine_python_sdk.model.add_funds_to_carrier_response_body import AddFundsToCarrierResponseBody as AddFundsToCarrierResponseBodySchema
from ship_engine_python_sdk.model.error_response_body import ErrorResponseBody as ErrorResponseBodySchema

from ship_engine_python_sdk.type.add_funds_to_carrier_response_body import AddFundsToCarrierResponseBody
...
from ship_engine_python_sdk.pydantic.add_funds_to_carrier_response_body import AddFundsToCarrierResponseBody as AddFundsToCarrierResponseBodyPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MonetaryValueSchema


request_body_monetary_value = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddFundsToCarrierResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AddFundsToCarrierResponseBody
...
class BaseApi(api_client.Api):
    ...
    def _add_funds_to_carrier_mapped_args(
        self,
        currency: str,
    ...
    async def _aadd_funds_to_carrier_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/carriers/{carrier_id}/add_funds',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_monetary_value.serialize(body, content_type)
    ...
    def _add_funds_to_carrier_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddFundsToCarrierRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_funds_to_carrier(
        self,
        currency: str,
        amount: typing.Union[int, float],
        carrier_id: SeId,
        **kwargs,
        ...
        args = self._add_funds_to_carrier_mapped_args(
            currency=currency,
            amount=amount,
            carrier_id=carrier_id,
        )
        return await self._aadd_funds_to_carrier_oapg(
            body=args.body,
    ...
    def add_funds_to_carrier(
        ...
        return self._add_funds_to_carrier_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddFundsToCarrier(BaseApi):
    ...
    async def aadd_funds_to_carrier(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AddFundsToCarrierResponseBodyPydantic:
        raw_response = await self.raw.aadd_funds_to_carrier(
            currency=currency,
            amount=amount,
            carrier_id=carrier_id,
            **kwargs,
        ...
        if validate:
            return AddFundsToCarrierResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(AddFundsToCarrierResponseBodyPydantic, raw_response.body)
    ...
    def add_funds_to_carrier(
        ...
        raw_response = self.raw.add_funds_to_carrier(
            currency=currency,
            amount=amount,
            carrier_id=carrier_id,
        )
