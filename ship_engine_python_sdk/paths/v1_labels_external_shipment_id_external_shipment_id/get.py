...
# Query params
LabelDownloadTypeSchema = LabelDownloadTypeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'label_download_type': typing.Union[LabelDownloadTypeSchema, ],
    },
    total=False
)
...
request_query_label_download_type = api_client.QueryParameter(
    name="label_download_type",
    style=api_client.ParameterStyle.FORM,
    schema=LabelDownloadTypeSchema,
    explode=True,
)
# Path params
ExternalShipmentIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'external_shipment_id': typing.Union[ExternalShipmentIdSchema, str, ],
    }
)
...
request_path_external_shipment_id = api_client.PathParameter(
    name="external_shipment_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ExternalShipmentIdSchema,
    required=True,
)
_auth = [
    'api_key',
...
class BaseApi(api_client.Api):
    ...
    def _get_by_external_shipment_id_mapped_args(
        self,
        ...
        if label_download_type is not None:
            _query_params["label_download_type"] = label_download_type
    ...
    async def _aget_by_external_shipment_id_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_external_shipment_id,
        ):
        ...
        for parameter in (
            request_query_label_download_type,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/labels/external_shipment_id/{external_shipment_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_by_external_shipment_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetByExternalShipmentIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_external_shipment_id(
        self,
        external_shipment_id: str,
        label_download_type: typing.Optional[LabelDownloadType] = None,
        **kwargs,
        ...
        args = self._get_by_external_shipment_id_mapped_args(
            external_shipment_id=external_shipment_id,
            label_download_type=label_download_type,
        )
        return await self._aget_by_external_shipment_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_external_shipment_id(
        self,
        external_shipment_id: str,
        label_download_type: typing.Optional[LabelDownloadType] = None,
    ) -> typing.Union[
        ...
        return self._get_by_external_shipment_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByExternalShipmentId(BaseApi):
    ...
    async def aget_by_external_shipment_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_external_shipment_id(
            external_shipment_id=external_shipment_id,
            label_download_type=label_download_type,
            **kwargs,
        )
    ...
    def get_by_external_shipment_id(
        ...
        raw_response = self.raw.get_by_external_shipment_id(
            external_shipment_id=external_shipment_id,
            label_download_type=label_download_type,
        )
        if validate:
