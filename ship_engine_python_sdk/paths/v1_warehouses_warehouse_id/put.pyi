...
class Warehouse0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awarehouse_0(
        self,
        warehouse_id: SeId,
        warehouse_id: typing.Optional[SeId] = None,
        is_default: typing.Optional[typing.Optional[bool]] = None,
        ...
        **kwargs,
        ...
        args = self._warehouse_0_mapped_args(
        ...
        return await self._awarehouse_0_oapg(
            body=args.body,
    ...
    def warehouse_0(
        ...
        return self._warehouse_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class Warehouse0(BaseApi):
    ...
    async def awarehouse_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awarehouse_0(
            warehouse_id=warehouse_id,
            warehouse_id=warehouse_id,
            is_default=is_default,
            name=name,
    ...
    def warehouse_0(
        ...
        raw_response = self.raw.warehouse_0(
            warehouse_id=warehouse_id,
            warehouse_id=warehouse_id,
            is_default=is_default,
            name=name,
