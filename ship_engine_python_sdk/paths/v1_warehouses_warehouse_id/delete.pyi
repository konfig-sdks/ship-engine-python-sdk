    ...
    async def _awarehouse_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/warehouses/{warehouse_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Warehouse1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awarehouse_1(
        self,
        warehouse_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._warehouse_1_mapped_args(
            warehouse_id=warehouse_id,
        )
        return await self._awarehouse_1_oapg(
    ...
    def warehouse_1(
        ...
        return self._warehouse_1_oapg(
            path_params=args.path,
        )

class Warehouse1(BaseApi):
    ...
    async def awarehouse_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awarehouse_1(
            warehouse_id=warehouse_id,
            **kwargs,
        )
        if validate:
    ...
    def warehouse_1(
        ...
        raw_response = self.raw.warehouse_1(
            warehouse_id=warehouse_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
