...
SchemaFor200ResponseBodyApplicationJson = PackageTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_custom_package_type_mapped_args(
        self,
    ...
    async def _acreate_custom_package_type_oapg(
        self,
    ...
    def _create_custom_package_type_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateCustomPackageTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_custom_package_type(
        self,
        package_code: PackageCode,
        name: str,
        description: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._create_custom_package_type_mapped_args(
        ...
        return await self._acreate_custom_package_type_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_custom_package_type(
        self,
        package_code: PackageCode,
        name: str,
        description: typing.Optional[typing.Optional[str]] = None,
        ...
        return self._create_custom_package_type_oapg(
            body=args.body,
        )

class CreateCustomPackageType(BaseApi):
    ...
    async def acreate_custom_package_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_custom_package_type(
            package_code=package_code,
            name=name,
            description=description,
            package_id=package_id,
        ...
        if validate:
            return PackageTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PackageTypePydantic, raw_response.body)
    ...
    def create_custom_package_type(
        ...
        raw_response = self.raw.create_custom_package_type(
            package_code=package_code,
            name=name,
            description=description,
            package_id=package_id,
