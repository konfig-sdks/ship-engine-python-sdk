...
from ship_engine_python_sdk.model.get_carriers_response_body import GetCarriersResponseBody as GetCarriersResponseBodySchema
...
from ship_engine_python_sdk.type.get_carriers_response_body import GetCarriersResponseBody

from ...api_client import Dictionary
from ship_engine_python_sdk.pydantic.error_response_body import ErrorResponseBody as ErrorResponseBodyPydantic
from ship_engine_python_sdk.pydantic.get_carriers_response_body import GetCarriersResponseBody as GetCarriersResponseBodyPydantic

SchemaFor200ResponseBodyApplicationJson = GetCarriersResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetCarriersResponseBody
...
SchemaFor207ResponseBodyApplicationJson = GetCarriersResponseBodySchema
...
class BaseApi(api_client.Api):
    ...
    def _carriers_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acarriers_oapg(
        self,
...
class CarriersRaw(BaseApi):
    ...
    async def acarriers(
        ...
        **kwargs,
        ...
        args = self._carriers_mapped_args(
        )
        return await self._acarriers_oapg(
            **kwargs,
        )
    ...
    def carriers(
        ...
        return self._carriers_oapg(
        )

class Carriers(BaseApi):

    async def acarriers(
        self,
        validate: bool = False,
        **kwargs,
    ) -> GetCarriersResponseBodyPydantic:
        raw_response = await self.raw.acarriers(
            **kwargs,
        )
        if validate:
            return RootModel[GetCarriersResponseBodyPydantic](raw_response.body).root
        return api_client.construct_model_instance(GetCarriersResponseBodyPydantic, raw_response.body)
    ...
    def carriers(
        ...
        raw_response = self.raw.carriers(
        )
        if validate:
            return RootModel[GetCarriersResponseBodyPydantic](raw_response.body).root
        return api_client.construct_model_instance(GetCarriersResponseBodyPydantic, raw_response.body)
