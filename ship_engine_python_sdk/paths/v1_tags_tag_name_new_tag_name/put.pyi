...
NewTagNameSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tag_name': typing.Union[TagNameSchema, ],
        'new_tag_name': typing.Union[TagNameSchema, ],
    }
)
...
request_path_new_tag_name = api_client.PathParameter(
    name="new_tag_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TagNameSchema,
    required=True,
    ...
    async def _atag_1_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tags/{tag_name}/{new_tag_name}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Tag1Raw(BaseApi):
    ...
    async def atag_1(
        ...
        **kwargs,
        ...
        args = self._tag_1_mapped_args(
            tag_name=tag_name,
            new_tag_name=new_tag_name,
        )
        return await self._atag_1_oapg(
...
class Tag1(BaseApi):
    ...
    async def atag_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atag_1(
            tag_name=tag_name,
            new_tag_name=new_tag_name,
            **kwargs,
        )
