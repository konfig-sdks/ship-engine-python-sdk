    ...
    async def _atracking_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tracking/start',
            auth_settings=_auth,
            headers=_headers,
        )
...
class TrackingRaw(BaseApi):
    ...
    async def atracking(
        ...
        **kwargs,
        ...
        args = self._tracking_mapped_args(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
        )
        return await self._atracking_oapg(
...
class Tracking(BaseApi):
    ...
    async def atracking(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atracking(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
            **kwargs,
        )
    ...
    def tracking(
        ...
        raw_response = self.raw.tracking(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
        )
        if validate:
