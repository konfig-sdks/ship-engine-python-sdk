...
from ship_engine_python_sdk.model.connect_insurer_request_body import ConnectInsurerRequestBody as ConnectInsurerRequestBodySchema
...
from ship_engine_python_sdk.type.connect_insurer_request_body import ConnectInsurerRequestBody
...
from ship_engine_python_sdk.pydantic.connect_insurer_request_body import ConnectInsurerRequestBody as ConnectInsurerRequestBodyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = ConnectInsurerRequestBodySchema


request_body_connect_insurer_request_body = api_client.RequestBody(
    content={
    ...
    async def _ainsurer_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/connections/insurance/shipsurance',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_connect_insurer_request_body.serialize(body, content_type)
...
class InsurerRaw(BaseApi):
    ...
    async def ainsurer(
        ...
        **kwargs,
        ...
        args = self._insurer_mapped_args(
            email=email,
            policy_id=policy_id,
        )
        return await self._ainsurer_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def insurer(
        ...
        return self._insurer_oapg(
            body=args.body,
        )

class Insurer(BaseApi):
    ...
    async def ainsurer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainsurer(
            email=email,
            policy_id=policy_id,
            **kwargs,
        )
