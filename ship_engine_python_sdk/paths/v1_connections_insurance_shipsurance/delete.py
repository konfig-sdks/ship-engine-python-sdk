...
class BaseApi(api_client.Api):
    ...
    def _insurer_0_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _ainsurer_0_oapg(
        self,
...
class Insurer0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainsurer_0(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._insurer_0_mapped_args(
        )
        return await self._ainsurer_0_oapg(
            **kwargs,
        )
    ...
    def insurer_0(
        ...
        return self._insurer_0_oapg(
        )

class Insurer0(BaseApi):
    ...
    async def ainsurer_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainsurer_0(
            **kwargs,
        )
        if validate:
    ...
    def insurer_0(
        ...
        raw_response = self.raw.insurer_0(
        )
        if validate:
            return Dictionary(**raw_response.body)
        return api_client.construct_model_instance(Dictionary, raw_response.body)
