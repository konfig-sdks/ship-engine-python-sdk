...
class BaseApi(api_client.Api):
    ...
    def _delete_custom_package_by_id_mapped_args(
        self,
        package_id: SeId,
    ...
    async def _adelete_custom_package_by_id_oapg(
        self,
    ...
    def _delete_custom_package_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteCustomPackageByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_custom_package_by_id(
        self,
        package_id: SeId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_custom_package_by_id_mapped_args(
            package_id=package_id,
        )
        return await self._adelete_custom_package_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_custom_package_by_id(
        self,
        package_id: SeId,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_custom_package_by_id_oapg(
            path_params=args.path,
        )

class DeleteCustomPackageById(BaseApi):
    ...
    async def adelete_custom_package_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_custom_package_by_id(
            package_id=package_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_custom_package_by_id(
        ...
        raw_response = self.raw.delete_custom_package_by_id(
            package_id=package_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
