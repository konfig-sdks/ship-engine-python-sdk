...
from ship_engine_python_sdk.model.package_type import PackageType as PackageTypeSchema
...
from ship_engine_python_sdk.pydantic.package_type import PackageType as PackageTypePydantic

# Path params
PackageIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'package_id': typing.Union[SeIdSchema, ],
    }
)
...
request_path_package_id = api_client.PathParameter(
    name="package_id",
...
# body param
SchemaForRequestBodyApplicationJson = PackageTypeSchema


request_body_package_type = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_custom_package_type_by_id_mapped_args(
        self,
        package_code: PackageCode,
        name: str,
        package_id: SeId,
        description: typing.Optional[typing.Optional[str]] = None,
        package_id: typing.Optional[SeId] = None,
    ...
    async def _aupdate_custom_package_type_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/packages/{package_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_package_type.serialize(body, content_type)
    ...
    def _update_custom_package_type_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCustomPackageTypeByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_custom_package_type_by_id(
        self,
        package_code: PackageCode,
        name: str,
        package_id: SeId,
        ...
        **kwargs,
        ...
        args = self._update_custom_package_type_by_id_mapped_args(
        ...
        return await self._aupdate_custom_package_type_by_id_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_custom_package_type_by_id(
        self,
        package_code: PackageCode,
        name: str,
        package_id: SeId,
        ...
        return self._update_custom_package_type_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateCustomPackageTypeById(BaseApi):
    ...
    async def aupdate_custom_package_type_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_custom_package_type_by_id(
            package_code=package_code,
            name=name,
            package_id=package_id,
            description=description,
    ...
    def update_custom_package_type_by_id(
        ...
        raw_response = self.raw.update_custom_package_type_by_id(
            package_code=package_code,
            name=name,
            package_id=package_id,
            description=description,
