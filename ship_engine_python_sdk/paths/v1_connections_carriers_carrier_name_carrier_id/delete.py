    ...
    async def _acarrier_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/connections/carriers/{carrier_name}/{carrier_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Carrier0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acarrier_0(
        self,
        carrier_name: CarrierName,
        carrier_id: SeId,
        **kwargs,
        ...
        args = self._carrier_0_mapped_args(
            carrier_name=carrier_name,
            carrier_id=carrier_id,
        )
        return await self._acarrier_0_oapg(
    ...
    def carrier_0(
        ...
        return self._carrier_0_oapg(
            path_params=args.path,
        )

class Carrier0(BaseApi):
    ...
    async def acarrier_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acarrier_0(
            carrier_name=carrier_name,
            carrier_id=carrier_id,
            **kwargs,
        )
    ...
    def carrier_0(
        ...
        raw_response = self.raw.carrier_0(
            carrier_name=carrier_name,
            carrier_id=carrier_id,
        )
        if validate:
