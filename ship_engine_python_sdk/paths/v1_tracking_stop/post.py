    ...
    async def _atracking_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tracking/stop',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Tracking0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atracking_0(
        self,
        carrier_code: typing.Optional[str] = None,
        tracking_number: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._tracking_0_mapped_args(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
        )
        return await self._atracking_0_oapg(
    ...
    def tracking_0(
        ...
        return self._tracking_0_oapg(
            query_params=args.query,
        )

class Tracking0(BaseApi):
    ...
    async def atracking_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atracking_0(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
            **kwargs,
        )
    ...
    def tracking_0(
        ...
        raw_response = self.raw.tracking_0(
            carrier_code=carrier_code,
            tracking_number=tracking_number,
        )
        if validate:
