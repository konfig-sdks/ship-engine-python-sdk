...
from ship_engine_python_sdk.model.rate import Rate as RateSchema
...
from ship_engine_python_sdk.type.rate import Rate

from ...api_client import Dictionary
from ship_engine_python_sdk.pydantic.rate import Rate as RatePydantic
...
SchemaFor200ResponseBodyApplicationJson = RateSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/rates/{rate_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return RatePydantic(**raw_response.body)
        return api_client.construct_model_instance(RatePydantic, raw_response.body)
