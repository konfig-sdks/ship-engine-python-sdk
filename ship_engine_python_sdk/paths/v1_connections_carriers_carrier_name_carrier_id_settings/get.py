...
from ship_engine_python_sdk.model.get_carrier_settings_response_body import GetCarrierSettingsResponseBody as GetCarrierSettingsResponseBodySchema
...
from ship_engine_python_sdk.type.get_carrier_settings_response_body import GetCarrierSettingsResponseBody
...
from ship_engine_python_sdk.pydantic.get_carrier_settings_response_body import GetCarrierSettingsResponseBody as GetCarrierSettingsResponseBodyPydantic
...
SchemaFor200ResponseBodyApplicationJson = GetCarrierSettingsResponseBodySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetCarrierSettingsResponseBody
...
class GetSettings(BaseApi):
    ...
    async def aget_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetCarrierSettingsResponseBodyPydantic:
        ...
        if validate:
            return RootModel[GetCarrierSettingsResponseBodyPydantic](raw_response.body).root
        return api_client.construct_model_instance(GetCarrierSettingsResponseBodyPydantic, raw_response.body)
