...
class BaseApi(api_client.Api):
    ...
    def _get_funds_balance_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_funds_balance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/insurance/shipsurance/balance',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFundsBalanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_funds_balance(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_funds_balance_mapped_args(
        )
        return await self._aget_funds_balance_oapg(
            **kwargs,
        )
    
    def get_funds_balance(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_funds_balance_oapg(
        )

class GetFundsBalance(BaseApi):
    ...
    async def aget_funds_balance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_funds_balance(
            **kwargs,
        )
        if validate:
    ...
    def get_funds_balance(
        ...
        raw_response = self.raw.get_funds_balance(
        )
        if validate:
            return MonetaryValuePydantic(**raw_response.body)
        return api_client.construct_model_instance(MonetaryValuePydantic, raw_response.body)
