...
from ship_engine_python_sdk.model.manifest import Manifest as ManifestSchema
...
from ship_engine_python_sdk.type.manifest import Manifest
...
from ship_engine_python_sdk.pydantic.manifest import Manifest as ManifestPydantic
from ship_engine_python_sdk.pydantic.error_response_body import ErrorResponseBody as ErrorResponseBodyPydantic

from . import path

# Path params
ManifestIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'manifest_id': typing.Union[SeIdSchema, ],
    }
)
...
request_path_manifest_id = api_client.PathParameter(
    name="manifest_id",
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/manifests/{manifest_id}',
            auth_settings=_auth,
            headers=_headers,
        )
