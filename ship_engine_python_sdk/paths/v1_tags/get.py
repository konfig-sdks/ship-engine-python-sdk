...
from ship_engine_python_sdk.model.list_tags_response_body import ListTagsResponseBody as ListTagsResponseBodySchema
...
from ship_engine_python_sdk.type.list_tags_response_body import ListTagsResponseBody

from ...api_client import Dictionary
from ship_engine_python_sdk.pydantic.error_response_body import ErrorResponseBody as ErrorResponseBodyPydantic
from ship_engine_python_sdk.pydantic.list_tags_response_body import ListTagsResponseBody as ListTagsResponseBodyPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListTagsResponseBodySchema
...
class BaseApi(api_client.Api):
    ...
    def _tags_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _atags_oapg(
        self,
...
class TagsRaw(BaseApi):
    ...
    async def atags(
        ...
        **kwargs,
        ...
        args = self._tags_mapped_args(
        )
        return await self._atags_oapg(
            **kwargs,
        )
...
class Tags(BaseApi):
    ...
    async def atags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListTagsResponseBodyPydantic:
        raw_response = await self.raw.atags(
            **kwargs,
        )
        if validate:
            return ListTagsResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListTagsResponseBodyPydantic, raw_response.body)
