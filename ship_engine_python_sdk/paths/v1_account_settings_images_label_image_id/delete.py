...
class BaseApi(api_client.Api):
    ...
    def _delete_image_by_id_mapped_args(
        self,
    ...
    async def _adelete_image_by_id_oapg(
        self,
...
class DeleteImageByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_image_by_id(
        self,
        label_image_id: ImageId,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_image_by_id_mapped_args(
            label_image_id=label_image_id,
        )
        return await self._adelete_image_by_id_oapg(
    ...
    def delete_image_by_id(
        ...
        return self._delete_image_by_id_oapg(
            path_params=args.path,
        )

class DeleteImageById(BaseApi):
    ...
    async def adelete_image_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_image_by_id(
            label_image_id=label_image_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_image_by_id(
        ...
        raw_response = self.raw.delete_image_by_id(
            label_image_id=label_image_id,
        )
        if validate:
            return EmptyResponseBodyPydantic(**raw_response.body)
