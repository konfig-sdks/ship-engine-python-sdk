...
class BaseApi(api_client.Api):
    ...
    def _list_images_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_images_oapg(
        self,
...
class ListImagesRaw(BaseApi):
    ...
    async def alist_images(
        ...
        **kwargs,
        ...
        args = self._list_images_mapped_args(
        )
        return await self._alist_images_oapg(
            **kwargs,
        )
...
class ListImages(BaseApi):
    ...
    async def alist_images(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_images(
            **kwargs,
        )
        if validate:
    ...
    def list_images(
        ...
        raw_response = self.raw.list_images(
        )
        if validate:
            return PagedListResponseBodyPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedListResponseBodyPydantic, raw_response.body)
