...
class Shipment2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashipment_2(
        self,
        shipment_id: SeId,
        tag_name: TagName,
        **kwargs,
        ...
        args = self._shipment_2_mapped_args(
            shipment_id=shipment_id,
            tag_name=tag_name,
        )
        return await self._ashipment_2_oapg(
    ...
    def shipment_2(
        ...
        return self._shipment_2_oapg(
            path_params=args.path,
        )

class Shipment2(BaseApi):
    ...
    async def ashipment_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashipment_2(
            shipment_id=shipment_id,
            tag_name=tag_name,
            **kwargs,
        )
    ...
    def shipment_2(
        ...
        raw_response = self.raw.shipment_2(
            shipment_id=shipment_id,
            tag_name=tag_name,
        )
        if validate:
