...
from ship_engine_python_sdk import rest
from ship_engine_python_sdk.api_response import ApiResponse, AsyncApiResponse
from ship_engine_python_sdk.rest import AsyncResponseWrapper, ResponseWrapper
from ship_engine_python_sdk.configuration import Configuration
from ship_engine_python_sdk.exceptions import ApiTypeError, ApiValueError, MissingRequiredParametersError
from ship_engine_python_sdk.request_after_hook import request_after_hook
from ship_engine_python_sdk.request_before_url_hook import request_before_url_hook
from ship_engine_python_sdk.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Konfig/1.1.202403202303/python'
