...
class RequiredBatchResponseError(TypedDict):
    pass

class OptionalBatchResponseError(TypedDict, total=False):
...
class BatchResponseError(RequiredBatchResponseError, OptionalBatchResponseError):
    pass
