...
class RequiredProcessBatchRequestBody(TypedDict):
    pass

class OptionalProcessBatchRequestBody(TypedDict, total=False):
...
class ProcessBatchRequestBody(RequiredProcessBatchRequestBody, OptionalProcessBatchRequestBody):
    pass
