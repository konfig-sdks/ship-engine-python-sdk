...
class RequiredLabelMessages(TypedDict):
    ...
    reference1: typing.Optional[str]
    ...
    reference2: typing.Optional[str]

    # The third line of the custom label message.  Some carriers may prefix this line with something like \"PO\", \"Reference 3\", etc. 
    reference3: typing.Optional[str]

class OptionalLabelMessages(TypedDict, total=False):
    pass

class LabelMessages(RequiredLabelMessages, OptionalLabelMessages):
    pass
