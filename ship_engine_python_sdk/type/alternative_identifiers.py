...
class RequiredAlternativeIdentifiers(TypedDict):
    pass

class OptionalAlternativeIdentifiers(TypedDict, total=False):
...
class AlternativeIdentifiers(RequiredAlternativeIdentifiers, OptionalAlternativeIdentifiers):
    pass
