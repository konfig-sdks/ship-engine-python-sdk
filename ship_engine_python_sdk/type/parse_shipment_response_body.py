...
from ship_engine_python_sdk.type.recognized_entity import RecognizedEntity

class RequiredParseShipmentResponseBody(TypedDict):
    ...
    entities: typing.List[RecognizedEntity]

class OptionalParseShipmentResponseBody(TypedDict, total=False):
    pass

class ParseShipmentResponseBody(RequiredParseShipmentResponseBody, OptionalParseShipmentResponseBody):
    pass
