...
class RequiredDhlExpressAccountSettings(TypedDict):
    pass

class OptionalDhlExpressAccountSettings(TypedDict, total=False):
    # Account nickname
    nickname: str
...
class DhlExpressAccountSettings(RequiredDhlExpressAccountSettings, OptionalDhlExpressAccountSettings):
    pass
