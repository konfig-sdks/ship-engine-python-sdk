...
class RequiredCreateLabelFromShipmentRequestBody(TypedDict):
    pass

class OptionalCreateLabelFromShipmentRequestBody(TypedDict, total=False):
...
class CreateLabelFromShipmentRequestBody(RequiredCreateLabelFromShipmentRequestBody, OptionalCreateLabelFromShipmentRequestBody):
    pass
