...
from ship_engine_python_sdk.type.normalized_entity import NormalizedEntity

class RequiredRecognizedEntity(TypedDict):
...
class OptionalRecognizedEntity(TypedDict, total=False):
    result: NormalizedEntity

class RecognizedEntity(RequiredRecognizedEntity, OptionalRecognizedEntity):
    pass
