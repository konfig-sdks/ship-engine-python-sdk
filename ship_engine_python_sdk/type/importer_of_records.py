...
class RequiredImporterOfRecords(TypedDict):
...
class OptionalImporterOfRecords(TypedDict, total=False):
...
class ImporterOfRecords(RequiredImporterOfRecords, OptionalImporterOfRecords):
    pass
