...
from ship_engine_python_sdk.type.manifest_download import ManifestDownload
from ship_engine_python_sdk.type.se_id import SeId

class RequiredDeprecatedManifest(TypedDict):
    pass

class OptionalDeprecatedManifest(TypedDict, total=False):
...
class DeprecatedManifest(RequiredDeprecatedManifest, OptionalDeprecatedManifest):
    pass
