...
from ship_engine_python_sdk.type.advanced_shipment_options_dangerous_goods_contact import AdvancedShipmentOptionsDangerousGoodsContact
from ship_engine_python_sdk.type.advanced_shipment_options_fedex_freight import AdvancedShipmentOptionsFedexFreight
from ship_engine_python_sdk.type.bill_to_party_nullable import BillToPartyNullable
from ship_engine_python_sdk.type.collect_on_delivery import CollectOnDelivery
from ship_engine_python_sdk.type.country_code import CountryCode
from ship_engine_python_sdk.type.origin_type_nullable import OriginTypeNullable
from ship_engine_python_sdk.type.weight_nullable import WeightNullable

class RequiredAdvancedShipmentOptions(TypedDict):
    pass

class OptionalAdvancedShipmentOptions(TypedDict, total=False):
    ...
    bill_to_account: typing.Optional[str]
    ...
    bill_to_country_code: CountryCode
    ...
    bill_to_party: typing.Optional[BillToPartyNullable]

    # The postal code of the third-party that is responsible for shipping costs. 
    bill_to_postal_code: typing.Optional[str]
    ...
    dry_ice_weight: typing.Optional[WeightNullable]
    ...
    use_ups_ground_freight_pricing: typing.Optional[bool]
    ...
    custom_field1: typing.Optional[str]

    # An arbitrary field that can be used to store information about the shipment. 
    custom_field2: typing.Optional[str]

    # An arbitrary field that can be used to store information about the shipment. 
    custom_field3: typing.Optional[str]

    origin_type: typing.Optional[OriginTypeNullable]

    # Indicate to the carrier that this shipment requires additional handling. 
    additional_handling: typing.Optional[bool]

    shipper_release: typing.Optional[bool]
...
class AdvancedShipmentOptions(RequiredAdvancedShipmentOptions, OptionalAdvancedShipmentOptions):
    pass
