...
class RequiredRateEstimateOptions(TypedDict):
    pass

class OptionalRateEstimateOptions(TypedDict, total=False):
...
class RateEstimateOptions(RequiredRateEstimateOptions, OptionalRateEstimateOptions):
    pass
