...
class RequiredConnectUpsRequestBody(TypedDict):
    # Nickname
    nickname: str
...
class OptionalConnectUpsRequestBody(TypedDict, total=False):
    # Title
    title: str
...
class ConnectUpsRequestBody(RequiredConnectUpsRequestBody, OptionalConnectUpsRequestBody):
    pass
