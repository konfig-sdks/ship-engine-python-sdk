...
from ship_engine_python_sdk.type.status_code import StatusCode
from ship_engine_python_sdk.type.track_event import TrackEvent
from ship_engine_python_sdk.type.tracking_number import TrackingNumber

class RequiredTrackingInformation(TypedDict):
    pass

class OptionalTrackingInformation(TypedDict, total=False):
    ...
    events: typing.List[TrackEvent]

class TrackingInformation(RequiredTrackingInformation, OptionalTrackingInformation):
    pass
