...
from ship_engine_python_sdk.type.dangerous_amount import DangerousAmount
from ship_engine_python_sdk.type.packaging_group import PackagingGroup
from ship_engine_python_sdk.type.packaging_instruction_section import PackagingInstructionSection
from ship_engine_python_sdk.type.regulation_level import RegulationLevel
from ship_engine_python_sdk.type.transport_mean import TransportMean

class RequiredDangerousGoods(TypedDict):
    pass

class OptionalDangerousGoods(TypedDict, total=False):
    # UN number to identify the dangerous goods.
    id_number: typing.Optional[str]

    # Trade description of the dangerous goods.
    shipping_name: typing.Optional[str]

    # Recognized Technical or chemical name of dangerous goods.
    technical_name: typing.Optional[str]
    ...
    product_class_subsidiary: typing.Optional[str]
    ...
    packaging_instruction: typing.Optional[str]
    ...
    additional_description: typing.Optional[str]

class DangerousGoods(RequiredDangerousGoods, OptionalDangerousGoods):
    pass
