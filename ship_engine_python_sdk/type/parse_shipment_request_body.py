...
class RequiredParseShipmentRequestBody(TypedDict):
    # The unstructured text that contains shipping-related entities
    text: str

class OptionalParseShipmentRequestBody(TypedDict, total=False):
...
class ParseShipmentRequestBody(RequiredParseShipmentRequestBody, OptionalParseShipmentRequestBody):
    pass
