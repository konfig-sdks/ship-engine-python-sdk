...
class RequiredParseAddressRequestBody(TypedDict):
    # The unstructured text that contains address-related entities
    text: str

class OptionalParseAddressRequestBody(TypedDict, total=False):
...
class ParseAddressRequestBody(RequiredParseAddressRequestBody, OptionalParseAddressRequestBody):
    pass
