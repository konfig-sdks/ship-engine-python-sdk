...
class RequiredParseAddressResponseBody(TypedDict):
...
class OptionalParseAddressResponseBody(TypedDict, total=False):
    pass

class ParseAddressResponseBody(RequiredParseAddressResponseBody, OptionalParseAddressResponseBody):
    pass
