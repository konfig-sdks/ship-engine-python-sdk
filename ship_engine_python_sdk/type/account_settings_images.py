...
class RequiredAccountSettingsImages(TypedDict):
    pass

class OptionalAccountSettingsImages(TypedDict, total=False):
...
class AccountSettingsImages(RequiredAccountSettingsImages, OptionalAccountSettingsImages):
    pass
