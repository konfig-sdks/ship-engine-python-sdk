...
class RequiredGetServicePointsRequestBody(TypedDict):
    providers: GetServicePointsRequestBodyProviders

class OptionalGetServicePointsRequestBody(TypedDict, total=False):
...
class GetServicePointsRequestBody(RequiredGetServicePointsRequestBody, OptionalGetServicePointsRequestBody):
    pass
