...
class RequiredPagedListResponseBody(TypedDict):
...
class OptionalPagedListResponseBody(TypedDict, total=False):
    pass

class PagedListResponseBody(RequiredPagedListResponseBody, OptionalPagedListResponseBody):
    pass
