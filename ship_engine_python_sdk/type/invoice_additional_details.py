...
class RequiredInvoiceAdditionalDetails(TypedDict):
    pass

class OptionalInvoiceAdditionalDetails(TypedDict, total=False):
...
class InvoiceAdditionalDetails(RequiredInvoiceAdditionalDetails, OptionalInvoiceAdditionalDetails):
    pass
