...
class RequiredCreateAndProcessBatchRequestBodyProcessLabels(TypedDict):
    pass

class OptionalCreateAndProcessBatchRequestBodyProcessLabels(TypedDict, total=False):
...
class CreateAndProcessBatchRequestBodyProcessLabels(RequiredCreateAndProcessBatchRequestBodyProcessLabels, OptionalCreateAndProcessBatchRequestBodyProcessLabels):
    pass
