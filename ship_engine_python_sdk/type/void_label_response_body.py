...
from ship_engine_python_sdk.type.reason_code import ReasonCode

class RequiredVoidLabelResponseBody(TypedDict):
    # Indicates whether the attempt to void the label was successful
    approved: bool

    message: str

class OptionalVoidLabelResponseBody(TypedDict, total=False):
...
class VoidLabelResponseBody(RequiredVoidLabelResponseBody, OptionalVoidLabelResponseBody):
    pass
