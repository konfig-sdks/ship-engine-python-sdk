...
class RequiredInternationalShipmentOptions(TypedDict):
...
class OptionalInternationalShipmentOptions(TypedDict, total=False):
...
class InternationalShipmentOptions(RequiredInternationalShipmentOptions, OptionalInternationalShipmentOptions):
    pass
