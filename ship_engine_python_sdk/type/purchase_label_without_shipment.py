...
class RequiredPurchaseLabelWithoutShipment(TypedDict):
    pass

class OptionalPurchaseLabelWithoutShipment(TypedDict, total=False):
...
class PurchaseLabelWithoutShipment(RequiredPurchaseLabelWithoutShipment, OptionalPurchaseLabelWithoutShipment):
    pass
