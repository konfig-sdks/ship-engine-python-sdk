...
from ship_engine_python_sdk.type.rate_estimate_error_messages import RateEstimateErrorMessages
from ship_engine_python_sdk.type.rate_estimate_warning_messages import RateEstimateWarningMessages
...
class RequiredRateEstimate(TypedDict):
    rate_type: RateType
    ...
    warning_messages: RateEstimateWarningMessages

    error_messages: RateEstimateErrorMessages

class OptionalRateEstimate(TypedDict, total=False):
...
class RateEstimate(RequiredRateEstimate, OptionalRateEstimate):
    pass
