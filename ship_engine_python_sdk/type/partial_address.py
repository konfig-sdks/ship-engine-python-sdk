...
class RequiredPartialAddress(TypedDict):
    pass

class OptionalPartialAddress(TypedDict, total=False):
...
class PartialAddress(RequiredPartialAddress, OptionalPartialAddress):
    pass
