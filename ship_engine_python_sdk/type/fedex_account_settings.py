...
from ship_engine_python_sdk.type.fedex_pickup_type import FedexPickupType
from ship_engine_python_sdk.type.smart_post_hub import SmartPostHub

class RequiredFedexAccountSettings(TypedDict):
    pass

class OptionalFedexAccountSettings(TypedDict, total=False):
    # Account nickname
    nickname: str
...
class FedexAccountSettings(RequiredFedexAccountSettings, OptionalFedexAccountSettings):
    pass
