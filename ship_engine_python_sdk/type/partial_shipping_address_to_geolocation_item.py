...
class RequiredPartialShippingAddressToGeolocationItem(TypedDict):
    pass

class OptionalPartialShippingAddressToGeolocationItem(TypedDict, total=False):
...
class PartialShippingAddressToGeolocationItem(RequiredPartialShippingAddressToGeolocationItem, OptionalPartialShippingAddressToGeolocationItem):
    pass
