...
class RequiredConnectDhlEcommerceRequestBody(TypedDict):
...
class OptionalConnectDhlEcommerceRequestBody(TypedDict, total=False):
...
class ConnectDhlEcommerceRequestBody(RequiredConnectDhlEcommerceRequestBody, OptionalConnectDhlEcommerceRequestBody):
    pass
