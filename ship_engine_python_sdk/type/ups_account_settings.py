...
class RequiredUpsAccountSettings(TypedDict):
    pass

class OptionalUpsAccountSettings(TypedDict, total=False):
    # nickname
    nickname: str
...
class UpsAccountSettings(RequiredUpsAccountSettings, OptionalUpsAccountSettings):
    pass
