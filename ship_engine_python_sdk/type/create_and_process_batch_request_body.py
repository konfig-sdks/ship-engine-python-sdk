...
class RequiredCreateAndProcessBatchRequestBody(TypedDict):
    pass

class OptionalCreateAndProcessBatchRequestBody(TypedDict, total=False):
    # A string that uniquely identifies the external batch
    external_batch_id: SeId

    # Add custom messages for a particular batch
    batch_notes: str

    # Array of shipment IDs used in the batch
    shipment_ids: typing.List[SeId]

    # Array of rate IDs used in the batch
    rate_ids: typing.List[SeId]

    process_labels: CreateAndProcessBatchRequestBodyProcessLabels

class CreateAndProcessBatchRequestBody(RequiredCreateAndProcessBatchRequestBody, OptionalCreateAndProcessBatchRequestBody):
    pass
