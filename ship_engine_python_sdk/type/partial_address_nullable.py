...
class RequiredPartialAddressNullable(TypedDict):
    pass

class OptionalPartialAddressNullable(TypedDict, total=False):
...
class PartialAddressNullable(RequiredPartialAddressNullable, OptionalPartialAddressNullable):
    pass
