...
class PartialAddressNullable(BaseModel):
    ...
    company_name: typing.Optional[typing.Optional[str]] = Field(None, alias='company_name')
    ...
    address_line3: typing.Optional[typing.Optional[str]] = Field(None, alias='address_line3')
