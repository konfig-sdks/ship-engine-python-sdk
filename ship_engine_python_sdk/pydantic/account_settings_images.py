...
from ship_engine_python_sdk.pydantic.image_id import ImageId
...
class AccountSettingsImages(BaseModel):
    ...
    label_image_id: typing.Optional[ImageId] = Field(None, alias='label_image_id')
    ...
    image_content_type: typing.Optional[str] = Field(None, alias='image_content_type')

    # A base64 encoded string representation of the image. 
    image_data: typing.Optional[str] = Field(None, alias='image_data')
