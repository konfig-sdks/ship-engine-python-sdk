...
from ship_engine_python_sdk.pydantic.manifest_download import ManifestDownload
...
class DeprecatedManifest(BaseModel):
    ...
    manifest_id: typing.Optional[SeId] = Field(None, alias='manifest_id')

    # WARNING: This property is deprecated
    # A string that uniquely identifies the form
    form_id: typing.Optional[SeId] = Field(None, alias='form_id')
    ...
    shipments: typing.Optional[int] = Field(None, alias='shipments')
    ...
    submission_id: typing.Optional[str] = Field(None, alias='submission_id')
    ...
    # WARNING: This property is deprecated
    manifest_download: typing.Optional[ManifestDownload] = Field(None, alias='manifest_download')
