...
class ConnectRoyalMailRequestBody(BaseModel):
    ...
    oba_email: typing.Optional[Email] = Field(None, alias='oba_email')
    ...
    # Street line1
    street_line1: typing.Optional[str] = Field(None, alias='street_line1')

    # Street line2
    street_line2: typing.Optional[str] = Field(None, alias='street_line2')

    # Street line3
    street_line3: typing.Optional[str] = Field(None, alias='street_line3')
