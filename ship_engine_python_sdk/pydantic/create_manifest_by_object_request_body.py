...
class CreateManifestByObjectRequestBody(BaseModel):
    ...
    warehouse_id: SeId = Field(alias='warehouse_id')

    # The ship date that the shipment will be sent out on
    ship_date: datetime = Field(alias='ship_date')

    # The list of label ids to exclude from the manifest
    excluded_label_ids: typing.Optional[typing.List[SeId]] = Field(None, alias='excluded_label_ids')
