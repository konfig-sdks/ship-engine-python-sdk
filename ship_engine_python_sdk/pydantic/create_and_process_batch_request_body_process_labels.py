...
class CreateAndProcessBatchRequestBodyProcessLabels(BaseModel):
    # When 'true', the batch will be enqueued for processing
    create_batch_and_process_labels: typing.Optional[bool] = Field(None, alias='create_batch_and_process_labels')
