...
class ConnectDhlEcommerceRequestBody(BaseModel):
    ...
    # The pickup number
    pickup_number: str = Field(alias='pickup_number')

    # The distribution center
    distribution_center: str = Field(alias='distribution_center')
    ...
    api_secret: typing.Optional[str] = Field(None, alias='api_secret')

    ancillary_endorsement: typing.Optional[AncillaryServiceEndorsement] = Field(None, alias='ancillary_endorsement')
    ...
    # WARNING: This property is deprecated
    # FTP username
    ftp_username: typing.Optional[str] = Field(None, alias='ftp_username')

    # WARNING: This property is deprecated
    # FTP password
    ftp_password: typing.Optional[str] = Field(None, alias='ftp_password')

    # Sold To field
    sold_to: typing.Optional[str] = Field(None, alias='sold_to')

    registration_id: typing.Optional[str] = Field(None, alias='registration_id')

    software_name: typing.Optional[str] = Field(None, alias='software_name')
