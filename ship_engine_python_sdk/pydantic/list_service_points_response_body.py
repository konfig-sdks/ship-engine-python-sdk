...
from ship_engine_python_sdk.pydantic.list_service_points_response_body_service_points import ListServicePointsResponseBodyServicePoints
...
class ListServicePointsResponseBody(BaseModel):
    ...
    service_points: typing.Optional[ListServicePointsResponseBodyServicePoints] = Field(None, alias='service_points')
