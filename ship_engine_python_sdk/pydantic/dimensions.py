...
from ship_engine_python_sdk.pydantic.dimension_unit import DimensionUnit

class Dimensions(BaseModel):
    unit: DimensionUnit = Field(alias='unit')

    # The length of the package, in the specified unit
    length: typing.Union[int, float] = Field(alias='length')
