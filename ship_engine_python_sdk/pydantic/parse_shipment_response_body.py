...
from ship_engine_python_sdk.pydantic.recognized_entity import RecognizedEntity
...
class ParseShipmentResponseBody(BaseModel):
    ...
    shipment: PartialShipment = Field(alias='shipment')
    ...
    entities: typing.List[RecognizedEntity] = Field(alias='entities')
