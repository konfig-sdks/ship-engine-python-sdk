...
from ship_engine_python_sdk.pydantic.email import Email
...
class ConnectUpsRequestBody(BaseModel):
    ...
    account_country_code: str = Field(alias='account_country_code')

    # Account postal code
    account_postal_code: str = Field(alias='account_postal_code')
    ...
    agree_to_technology_agreement: bool = Field(alias='agree_to_technology_agreement')
    ...
    invoice_currency_code: typing.Optional[str] = Field(None, alias='invoice_currency_code')
