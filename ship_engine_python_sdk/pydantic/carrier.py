...
from ship_engine_python_sdk.pydantic.carrier_advanced_option import CarrierAdvancedOption
from ship_engine_python_sdk.pydantic.carrier_code import CarrierCode
from ship_engine_python_sdk.pydantic.package_type import PackageType
from ship_engine_python_sdk.pydantic.se_id import SeId
from ship_engine_python_sdk.pydantic.service import Service
...
class Carrier(BaseModel):
    ...
    requires_funded_amount: typing.Optional[bool] = Field(None, alias='requires_funded_amount')
    ...
    has_multi_package_supporting_services: typing.Optional[bool] = Field(None, alias='has_multi_package_supporting_services')

    # The carrier supports adding custom label messages to an order.
    supports_label_messages: typing.Optional[bool] = Field(None, alias='supports_label_messages')

    # The carrier is disabled by the current ShipEngine account's billing plan.
    disabled_by_billing_plan: typing.Optional[bool] = Field(None, alias='disabled_by_billing_plan')

    # A list of services that are offered by the carrier
    services: typing.Optional[typing.List[Service]] = Field(None, alias='services')

    # A list of package types that are supported by the carrier
    packages: typing.Optional[typing.List[PackageType]] = Field(None, alias='packages')

    # A list of options that are available to that carrier
    options: typing.Optional[typing.List[CarrierAdvancedOption]] = Field(None, alias='options')
