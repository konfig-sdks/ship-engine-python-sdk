...
class ShipmentItem(BaseModel):
    ...
    # sales order id
    sales_order_id: typing.Optional[typing.Optional[str]] = Field(None, alias='sales_order_id')

    # sales order item id
    sales_order_item_id: typing.Optional[typing.Optional[str]] = Field(None, alias='sales_order_item_id')
    ...
    external_order_item_id: typing.Optional[typing.Optional[str]] = Field(None, alias='external_order_item_id')

    # Amazon Standard Identification Number
    asin: typing.Optional[typing.Optional[str]] = Field(None, alias='asin')
