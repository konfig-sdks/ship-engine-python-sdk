...
class Warehouse(BaseModel):
    ...
    is_default: typing.Optional[typing.Optional[bool]] = Field(None, alias='is_default')
    ...
    origin_address: typing.Optional[PartialAddress] = Field(None, alias='origin_address')

    # The return address associated with the warehouse
    return_address: typing.Optional[PartialAddress] = Field(None, alias='return_address')
