...
from ship_engine_python_sdk.pydantic.rate_error_messages import RateErrorMessages
from ship_engine_python_sdk.pydantic.rate_type import RateType
from ship_engine_python_sdk.pydantic.rate_warning_messages import RateWarningMessages
...
class Rate(BaseModel):
    ...
    rate_id: SeId = Field(alias='rate_id')
    ...
    warning_messages: RateWarningMessages = Field(alias='warning_messages')

    error_messages: RateErrorMessages = Field(alias='error_messages')
