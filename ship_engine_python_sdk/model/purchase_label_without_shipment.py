...
class PurchaseLabelWithoutShipment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["validate_address", "label_layout", "label_format", "label_download_type", "display_scheme", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["validate_address", "label_layout", "label_format", "label_download_type", "display_scheme", ], str]):
