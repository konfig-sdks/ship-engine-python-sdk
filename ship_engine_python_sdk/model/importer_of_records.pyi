...
class ImporterOfRecords(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "address_line1", "city_locality", "postal_code", "country_code", "phone", "email", "company_name", "address_line2", "address_line3", "state_province", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "address_line1", "city_locality", "postal_code", "country_code", "phone", "email", "company_name", "address_line2", "address_line3", "state_province", ], str]):
