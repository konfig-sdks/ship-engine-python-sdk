...
| `leave_if_no_response`         |
    ...
    @schemas.classproperty
    def RETURN_SERVICE_REQUESTED(cls):
        return cls("return_service_requested")
    
    @schemas.classproperty
    def FORWARDING_SERVICE_REQUESTED(cls):
        return cls("forwarding_service_requested")
    
    @schemas.classproperty
    def ADDRESS_SERVICE_REQUESTED(cls):
        return cls("address_service_requested")
    
    @schemas.classproperty
    def CHANGE_SERVICE_REQUESTED(cls):
        return cls("change_service_requested")
    
    @schemas.classproperty
    def LEAVE_IF_NO_RESPONSE(cls):
        return cls("leave_if_no_response")
