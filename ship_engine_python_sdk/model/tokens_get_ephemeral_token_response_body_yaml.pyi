...
class TokensGetEphemeralTokenResponseBodyYaml(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "redirect_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "redirect_url", ], str]):
