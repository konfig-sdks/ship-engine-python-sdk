...
class AddFundsToCarrierResponseBody(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def balance() -> typing.Type['MonetaryValue']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["balance"]) -> 'MonetaryValue': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["balance"]) -> 'MonetaryValue': ...
