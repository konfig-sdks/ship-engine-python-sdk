...
class ValidateShipmentFields(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["validate_address", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["validate_address", ], str]):
