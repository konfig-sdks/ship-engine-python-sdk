...
class DangerousAmount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "unit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "unit", ], str]):
