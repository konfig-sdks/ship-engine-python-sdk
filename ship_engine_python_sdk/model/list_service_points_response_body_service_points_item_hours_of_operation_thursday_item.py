...
class ListServicePointsResponseBodyServicePointsItemHoursOfOperationThursdayItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ListServicePointsResponseBodyServicePointsItemHoursOfOperationThursdayItem':
