...
class ConnectCarrierResponseBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["carrier_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["carrier_id", ], str]):
