...
class ReasonCode(
    ...
    @schemas.classproperty
    def LABEL_NOT_FOUND_WITHIN_VOID_PERIOD(cls):
        return cls("label_not_found_within_void_period")
    
    @schemas.classproperty
    def LABEL_ALREADY_USED(cls):
        return cls("label_already_used")
    
    @schemas.classproperty
    def LABEL_ALREADY_VOIDED(cls):
        return cls("label_already_voided")
