...
class ConnectDhlExpressUkRequestBody(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["site_id"]) -> 'SeId': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_number", "site_id", "password", "nickname", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["site_id"]) -> 'SeId': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_number", "site_id", "password", "nickname", ], str]):
