...
class ConnectInsurerRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "policy_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "policy_id", ], str]):
