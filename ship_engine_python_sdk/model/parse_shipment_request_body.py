...
class ParseShipmentRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["text", "shipment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["text", "shipment", ], str]):
