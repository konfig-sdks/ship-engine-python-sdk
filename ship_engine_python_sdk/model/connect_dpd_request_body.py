...
class ConnectDpdRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_number", "password", "nickname", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_number", "password", "nickname", ], str]):
