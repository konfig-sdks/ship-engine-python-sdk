...
class ProcessBatchRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ship_date", "label_layout", "label_format", "display_scheme", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ship_date", "label_layout", "label_format", "display_scheme", ], str]):
