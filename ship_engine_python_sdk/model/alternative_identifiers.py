...
class AlternativeIdentifiers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["alternative_identifiers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["alternative_identifiers", ], str]):
