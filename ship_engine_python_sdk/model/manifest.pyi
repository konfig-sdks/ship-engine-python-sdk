...
number of shipments
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["manifest_id", "form_id", "created_at", "ship_date", "shipments", "label_ids", "warehouse_id", "submission_id", "carrier_id", "manifest_download", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["manifest_id", "form_id", "created_at", "ship_date", "shipments", "label_ids", "warehouse_id", "submission_id", "carrier_id", "manifest_download", ], str]):
