...
class ConnectAustraliaPostRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_number", "api_key", "api_secret", "nickname", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_number", "api_key", "api_secret", "nickname", ], str]):
