...
class RateEstimate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def warning_messages() -> typing.Type['RateEstimateWarningMessages']:
                return RateEstimateWarningMessages
        
            @staticmethod
            def error_messages() -> typing.Type['RateEstimateErrorMessages']:
                return RateEstimateErrorMessages
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["warning_messages"]) -> 'RateEstimateWarningMessages': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["error_messages"]) -> 'RateEstimateErrorMessages': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rate_type", "carrier_id", "shipping_amount", "insurance_amount", "confirmation_amount", "other_amount", "zone", "package_type", "guaranteed_service", "negotiated_rate", "service_type", "service_code", "trackable", "carrier_code", "carrier_nickname", "carrier_friendly_name", "validation_status", "warning_messages", "error_messages", "tax_amount", "delivery_days", "estimated_delivery_date", "carrier_delivery_days", "ship_date", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["warning_messages"]) -> 'RateEstimateWarningMessages': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["error_messages"]) -> 'RateEstimateErrorMessages': ...
