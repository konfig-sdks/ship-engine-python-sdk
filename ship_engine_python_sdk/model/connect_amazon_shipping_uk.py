...
class ConnectAmazonShippingUk(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nickname", "auth_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nickname", "auth_code", ], str]):
