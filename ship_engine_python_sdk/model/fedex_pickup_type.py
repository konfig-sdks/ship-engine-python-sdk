...
|`station`                 | You will drop-off the package at a FedEx Station
    ...
    @schemas.classproperty
    def REGULAR_PICKUP(cls):
        return cls("regular_pickup")
    
    @schemas.classproperty
    def REQUEST_COURIER(cls):
        return cls("request_courier")
    ...
    @schemas.classproperty
    def BUSINESS_SERVICE_CENTER(cls):
        return cls("business_service_center")
