...
class RegulationLevel(
    ...
    def LIGHTLY_REGULATED(cls):
        return cls("lightly_regulated")
    
    @schemas.classproperty
    def FULLY_REGULATED(cls):
        return cls("fully_regulated")
    
    @schemas.classproperty
    def LIMITED_QUANTITIES(cls):
        return cls("limited_quantities")
    
    @schemas.classproperty
    def EXCEPTED_QUANTITY(cls):
        return cls("excepted_quantity")
