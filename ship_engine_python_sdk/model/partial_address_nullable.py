...
class PartialAddressNullable(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address_line3"]) -> MetaOapg.properties.address_line3: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "phone", "email", "company_name", "address_line1", "address_line2", "address_line3", "city_locality", "state_province", "postal_code", "country_code", "address_residential_indicator", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address_line3"]) -> typing.Union[MetaOapg.properties.address_line3, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "phone", "email", "company_name", "address_line1", "address_line2", "address_line3", "city_locality", "state_province", "postal_code", "country_code", "address_residential_indicator", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        address_line3: typing.Union[MetaOapg.properties.address_line3, None, str, schemas.Unset] = schemas.unset,
