...
class ConnectDhlExpressAuRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nickname", "account_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nickname", "account_number", ], str]):
