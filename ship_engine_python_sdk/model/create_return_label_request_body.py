...
class CreateReturnLabelRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["charge_event", "label_layout", "label_format", "label_download_type", "display_scheme", "label_image_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["charge_event", "label_layout", "label_format", "label_download_type", "display_scheme", "label_image_id", ], str]):
