...
class ConnectDhlExpressRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nickname", "account_number", "site_id", "password", "country_code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nickname", "account_number", "site_id", "password", "country_code", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        site_id: typing.Union[MetaOapg.properties.site_id, str, schemas.Unset] = schemas.unset,
