...
class PagedListResponseBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total"], typing_extensions.Literal["pages"], typing_extensions.Literal["links"], typing_extensions.Literal["page"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total"], typing_extensions.Literal["pages"], typing_extensions.Literal["links"], typing_extensions.Literal["page"], str, ]):
