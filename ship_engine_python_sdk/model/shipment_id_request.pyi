...
class ShipmentIdRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["shipment_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["shipment_id", ], str]):
