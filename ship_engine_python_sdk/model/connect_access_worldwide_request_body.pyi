...
class ConnectAccessWorldwideRequestBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nickname", "username", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nickname", "username", "password", ], str]):
