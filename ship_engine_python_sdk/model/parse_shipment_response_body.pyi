...
class ParseShipmentResponseBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["score", "shipment", "entities", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipment"]) -> 'PartialShipment': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["score", "shipment", "entities", ], str]):
